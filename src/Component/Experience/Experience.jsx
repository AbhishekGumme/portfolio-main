  ...
  return (
    <div className="experience">
      ...
      <div className="education-container">
            ...
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>80.06 %</div>
        ...
        <div className="education">
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>60.00 %</div>
            <span style={{color : "#5b96a9"}}> <FontAwesomeIcon icon={faGraduationCap} />Rajeshri Shahu</span>
            <span style={{color : "#f19602"}}>Science College</span>
        </div>
        <div className="education">
            <div className="new_circle" style={{ boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.9)" }}>86.20%</div>
            <span style={{color : "#5b96a9"}}>    <FontAwesomeIcon icon={faSchool} />Saraswati Vidyalay, Latur</span>
